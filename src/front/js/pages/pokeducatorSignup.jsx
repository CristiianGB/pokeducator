...
const PokeducatorSignup = (props) => {
  ...
  const handleSignup = async () => {
    const resp = await fetch(
      "https://3001-cristiiangb-pokeducator-fu5j0pzdhxm.ws-eu75.gitpod.io/api/signup",
      {
        method: "POST",
      ...
      <div class="col-lg-12 col-xl-11">
        ...
        <div class="card text-black" >
          <div class="card-body p-md-5">
            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Únete a Pokeducator!</p>
            ...
            setUsername(e.target.value);
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1c" class="form-control" name="usuario" onChange={(e) => {
                        setUsername(e.target.value);
                      }} />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-id-card fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <input type="text" id="form3Example1c" name="nombre" onChange={(e) => {
          ...
          onChange={(e) => {
            setLastName(e.target.value);
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="email" id="form3Example3c" class="form-control" name="correo"
          ...
          onChange={(e) => {
            setEmail(e.target.value);
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4c" class="form-control" name="contraseña"
          ...
          onChange={(e) => {
            setPassword(e.target.value);
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" class="form-control" onChange={(e) => {
            setPasswordCheck(e.target.value);
                  ...
                  <div class="form-check d-flex justify-content-center mb-5">
                    ...
                    <label class="form-check-label" for="form2Example3">
                      Estoy de acuerdo con los <a className="links"href="https://www.pokemon.com/es/condiciones-de-uso/">Términos de servicio</a>
                    </label>
                  </div>

                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4 separadorBottom pb-4">
                    
                    <button  type="button" class="btn botons buttonPokemonInfo"
          onClick={() => {
          ...
          value="Registrar">Registrar</button>
                  ...
                  <a className="links" href="/login"><p className=" text-center">
                  Ya tengo cuenta.
                   </p></a>
                </form>
              ...
              <div class="redondearIzquierdo col-md-10 col-lg-6 col-xl-7 d-flex text-center justify-content-center align-items-center flex-column order-1 order-lg-2 gradient-custom-2">
                ...
                <p className=" text-white text-center">Con una cuenta del Club de Entrenadores Pokémon puedes:
¡Acceder a aplicaciones de Pokémon, suscribirte a boletines informativos y mucho más!

Si ya tienes una cuenta, por favor, inicia sesión ahora.</p>
                <img width="40%" src="https://i.gifer.com/WiCJ.gif"
                  class="img-fluid" alt="Pikachu saludo"/>
